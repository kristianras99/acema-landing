    ...
    <div style={{ background: '#0A0A0A', color: '#F5F0E8' }} className="min-h-screen font-sans">
      ...
      <nav style={{ borderBottom: '1px solid #1B4332' }} className="px-6 py-4 flex justify-between items-center sticky top-0 z-50">
        <div style={{ color: '#C9A84C' }} className="text-2xl font-bold tracking-widest">ACEMA</div>
          ...
          className="px-6 py-2 rounded-lg font-bold text-sm hover:opacity-90 transition-all"
        >
      ...
      <section className="px-6 py-32 text-center max-w-4xl mx-auto">
        <div style={{ background: '#1B4332', color: '#C9A84C', border: '1px solid #2D6A4F' }} className="inline-block px-4 py-1 rounded-full text-sm mb-6">
          AI-puhelinassistentti yrityksellesi
        </div>
        <h1 className="text-5xl font-bold mb-6 leading-tight">
          Anna AI:n hoitaa<br />
          <span style={{ color: '#C9A84C' }}>puhelut puolestasi</span>
        </h1>
        <p style={{ color: '#8A9E8A' }} className="text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          Acema räätälöi yrityksellesi AI-puhelinassistentin joka vastaa puheluihin,
          varaa aikoja ja kerää asiakastiedot — 24/7 ilman taukoja.
        </p>
        <div className="flex gap-4 justify-center flex-wrap">
            ...
            target="_blank"
            style={{ background: '#C9A84C', color: '#0A0A0A' }}
            className="px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition-all"
          >
            Varaa ilmainen esittely →
          </a>
          
            href="#miten-toimii"
            style={{ border: '1px solid #1B4332', color: '#F5F0E8' }}
            className="px-8 py-4 rounded-lg font-bold text-lg hover:opacity-80 transition-all"
          >
            Lue lisää
          </a>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { step: '02', title: 'Räätälöinti', desc: 'Konfiguroimme AI-assistentin juuri sinun toimialalllesi — puheluihin vastaamiseen, ajanvarauksiin ja asiakastietojen keräämiseen.' },
      ...
      <section style={{ borderTop: '1px solid #1B4332', background: '#0D1F0D' }} className="px-6 py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p style={{ color: '#8A9E8A' }} className="text-lg leading-relaxed">
            Jos et ole tyytyväinen palveluun ensimmäisen kuukauden aikana,
            palautamme kuukausimaksun — ei kysymyksiä. Haluamme että jokainen asiakas
            on täysin tyytyväinen ennen kuin sitoutuu pitkäaikaiseen yhteistyöhön.
          </p>
        </div>
      </section>
      ...
      <section style={{ borderTop: '1px solid #1B4332', background: '#0D1F0D' }} className="px-6 py-24 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p style={{ color: '#8A9E8A' }} className="text-lg mb-10">
            Varaa ilmainen 30 minuutin esittely — käymme läpi miten AI-assistentti
            sopii juuri sinun yritykseesi.
          </p>
          
            href={CALENDAR_LINK}
            target="_blank"
            style={{ background: '#C9A84C', color: '#0A0A0A' }}
            className="inline-block px-10 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition-all"
          >
            Varaa esittely →
          </a>
        </div>
